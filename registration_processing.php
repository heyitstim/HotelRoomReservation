    ...
    <body>
        ...
        if(duplicates($u_name) == false){
           ...
           //echo $u_email;
              ...
              echo '<meta http-equiv="refresh" content="3; URL=log_in.php"><meta name="keywords" content="automatic redirection">';
        }
        }else{
            echo '<h1>Username Exists</h1>';
            echo '<meta http-equiv="refresh" content="3; URL=userinfo.php"><meta name="keywords" content="automatic redirection">';
